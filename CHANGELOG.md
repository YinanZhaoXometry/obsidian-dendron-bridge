...
- Added command to open Dendron Bridge tree in sidebar.

## 2.0.3

- Fixed a bug that auto-revealed the pane with Dendron Bridge on it when moving to a new note and the "Reveal File" option was enabled in the settings.
