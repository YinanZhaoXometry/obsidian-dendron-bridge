...
export class NoteTree {
  ...
  constructor(settings: DendronBridgePluginSettings) {
  ...
  addFile(file: TFile, settings: DendronBridgePluginSettings, sort = false) {
  ...
  getFromFileName(name: string, settings: DendronBridgePluginSettings) {
  ...
  deleteByFileName(name: string, settings: DendronBridgePluginSettings) {
