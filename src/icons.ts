...
export const dendronBridgeActivityBarName = "dendron-bridge-activity-bar";

// Function to wrap the SVG path in an SVG element
export function getDendronBridgeActivityBarIcon(svgPath: string): string {
